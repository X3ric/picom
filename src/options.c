...
static const struct picom_option picom_options[] = {
	...
	{"animation-exclude"             , required_argument, 812, NULL        , "Exclude animations for windows."},
	{"animation-for-menu-window"     , required_argument, 813, NULL        , "Set animation for menu windows."},
	{"undirected"                    , no_argument      , 814, NULL        , "Enable/disable direction desktop based animations."},
};
// clang-format on
